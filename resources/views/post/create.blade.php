    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <form class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
              <label for="star-tdate" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">開始日</label>
            ...
            <div class="sm:col-span-2">
              <label for="upload" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">画像、動画アップロード</label>
